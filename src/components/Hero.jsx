...
const Hero = () => {
  return (
    <section
      className="hero-container px-5 md:px-16  flex flex-row justify-between items-center h-[calc(100vh-64px)]
       bg-cover bg-center text-center bg-[#C890A7] pb-10"
    >
      {/* hero text and head */}
      <div className=" w-full lg:w-[50%] text-left flex flex-col gap-5 justify-center">
        <h1 className="hero-text roboto-mono tracking-normal text-4xl md:text-5xl leading-10 md:leading-16 font-medium pr-20 text-[#FBF5E5] mb-4">
